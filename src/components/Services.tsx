              ...
              <Card key={service.id} className="shadow-soft hover:shadow-medium transition-all duration-300 group">
                ...
                <CardContent>
                  ...
                  <Button 
                    variant="cta" 
                    className="w-full"
                    onClick={() => window.open(`https://wa.me/5548935249958?text=Olá! Gostaria de solicitar o serviço: ${service.title}`, '_blank')}
                  >
        ...
        <div className="bg-gradient-subtle rounded-2xl p-8 md:p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Button 
              variant="hero" 
              size="lg"
              onClick={() => window.open('https://wa.me/5548935249958?text=Olá! Preciso de um serviço personalizado para tacógrafos. Gostaria de falar com um especialista.', '_blank')}
            >
            ...
            <Button 
              variant="contact" 
              size="lg"
              onClick={() => window.open('https://wa.me/5548935249958?text=Olá! Gostaria de conhecer todos os serviços disponíveis para tacógrafos.', '_blank')}
            >
